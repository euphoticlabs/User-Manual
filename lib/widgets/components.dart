...
class ComponentsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final components = [
      ...
      {'label': 'Oil & Water', 'image': '${R.components}liquid.png'},
      {'label': 'Chimney', 'image': '${R.components}chimney.png'},
      {'label': 'Stirrer', 'image': '${R.components}stirrer.png'},
      {'label': 'Induction', 'image': '${R.components}induction.png'},
      {'label': 'Pan', 'image': '${R.components}pan.png'},
