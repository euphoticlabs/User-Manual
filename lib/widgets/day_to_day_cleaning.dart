    ...
    Widget buildListItem(String text) => Padding(
          ...
          child: Row(
            ...
            children: [
              Expanded(
                child:
                    Text(text, style: TextStyle(fontSize: sectionFontSize)),
              ),
            ],
          ),
        );
        ...
        children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      buildListItem('4. Optionally you can wash in Dishwasher'),
                    ],
                  ),
                ),
          ...
          Column(
            children: [
              ...
              Text('Tray and Sliders Separated',
                  textAlign: TextAlign.center,
                  style: TextStyle(fontSize: sectionFontSize * 0.9)),
            ],
          ),
          const SizedBox(height: 16),
          Column(
            children: [
              ...
              Text(
                  'Preferable tray drying position, Upside down and sliders partially out',
                  textAlign: TextAlign.center,
                  style: TextStyle(fontSize: sectionFontSize * 0.9)),
            ],
          ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      buildListItem('2. Wipe the interior clean with a wet cloth'),
                      buildListItem(
